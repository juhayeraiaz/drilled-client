        ...
        <div className='my-28'>
            <div class="mx-auto container">
                <div data-aos="fade-right"
                    ...
                    data-aos-once="false"
                    data-aos-anchor-placement="top" class="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                    <div class="flex justify-center w-full lg:border-r border-gray-300 py-6">
                        ...
                        <div class="pl-12 w-1/2">
                            <h1 class="font-bold text-2xl lg:text-5xl tracking-1px">450K</h1>
                    ...
                    <div class="flex justify-center w-full lg:border-r border-gray-300 py-6">
                        ...
                        <div class="w-1/2 pl-12">
                            <h1 class="font-bold text-2xl lg:text-5xl tracking-1px">9</h1>
