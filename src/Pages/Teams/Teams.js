        ...
        <div>
            <div className='mb-10'>
                <div className="flex justify-center pt-16">
                    <div>
                        <h1 className="xl:text-4xl text-3xl text-center font-extrabold pb-6 sm:w-4/6 w-5/6 mx-auto">The Talented People Behind the Scenes of the Company</h1>
                    </div>
                </div>
                <div className="pt-10 mt-10 relative">
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 items-center gap-5 gap-y-32 justify-center w-[95%] mx-auto">
                        <div className="w-2/3 relative mx-auto">
                            <div className="rounded overflow-hidden shadow-md bg-neutral xl:h-[320px] md:h-[400px] lg:h-auto">
                                ...
                                <div className="px-6 mt-16">
                                    ...
                                    <p className="text-center  text-base pt-3 font-normal">The CEO's role in raising a company's corporate IQ is to establish an atmosphere that promotes knowledge sharing and collaboration.</p>
                        ...
                        <div className="w-2/3 relative mx-auto">
                            <div className="rounded overflow-hidden shadow-md bg-neutral xl:h-[320px] md:h-[400px] lg:h-auto">
                                ...
                                <div className="px-6 mt-16">
                                    ...
                                    <p className="text-center  text-base pt-3 font-normal">The emphasis on innovation and technology in our companies has resulted in a few of them establishing global benchmarks in product design and development.</p>
                                    <div className="w-full flex justify-center pt-5 pb-5">
                                        <a href="#/" className="mx-5">
                                            <div>
                                                <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="#718096" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="feather feather-github">
                        ...
                        <div className="w-2/3 relative mx-auto">
                            <div className="rounded overflow-hidden shadow-md bg-neutral xl:h-[320px] md:h-[400px] lg:h-auto">
                                ...
                                <div className="px-6 mt-16">
                                    ...
                                    <p className="text-center  text-base pt-3 font-normal">Our services encompass the assessment and repair of property damage caused by water, fire, smoke, or mold. We can also be a part of the restoration.</p>
                                    <div className="w-full flex justify-center pt-5 pb-5">
                                        <a href="#/" className="mx-5">
                                            <div>
                                                <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="#718096" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="feather feather-github">
                        ...
                        <div className="w-2/3 relative mx-auto">
                            <div className="rounded overflow-hidden shadow-md bg-neutral xl:h-[320px] md:h-[400px] lg:h-auto">
                                ...
                                <div className="px-6 mt-16">
                                    ...
                                    <p className=" text-sm text-center">Principal Engineer</p>
                                    <p className="text-center  text-base pt-3 font-normal">An avid open-source engineer who loves to be creative and inventive. I have 20 years of experience in the field.</p>
                                    <div className="w-full flex justify-center pt-5 pb-5">
                                        <a href="#/" className="mx-5">
                                            <div>
                                                <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="#718096" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="feather feather-github">
                        ...
                        <div className="w-2/3 relative mx-auto">
                            <div className="rounded overflow-hidden shadow-md bg-neutral xl:h-[320px] md:h-[400px] lg:h-auto">
                                ...
                                <div className="px-6 mt-16">
                                    ...
                                    <p className=" text-sm text-center">Product Design Head</p>
                                    <p className="text-center  text-base pt-3 font-normal">Product designer with interests in immersive computing and XR, political ventures, and emerging technologies. Able to take ideas and give them a life.</p>
                                    <div className="w-full flex justify-center pt-5 pb-5">
                                        <a href="#/" className="mx-5">
                                            <div>
                                                <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="#718096" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="feather feather-github">
                        ...
                        <div className="w-2/3 relative mx-auto">
                            <div className="rounded overflow-hidden shadow-md bg-neutral xl:h-[320px] md:h-[400px] lg:h-auto">
                                ...
                                <div className="px-6 mt-16">
                                    ...
                                    <p className="text-sm text-center">Floor Manager</p>
                                    <p className="text-center  text-base pt-3 font-normal">Checking every bit of the floor to make all works right and solves the problemsthat occur.</p>
                                    <div className="w-full flex justify-center pt-5 pb-5">
                                        <a href="#/" className="mx-5">
                                            <div>
                                                <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="#718096" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="feather feather-github">
